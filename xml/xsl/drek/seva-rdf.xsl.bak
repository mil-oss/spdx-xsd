...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:spd="spdx:xsd::1.0/ref" xmlns:exsl="http://exslt.org/common"
    ...
    xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:seva="spdx:xsd::1.0" version="1.0">
    ...
    <xsl:variable name="SEVA" select="document('../xsd/seva.xsd')/xs:schema"/>
    ...
    <xsl:template name="main">
        ...
        <rdf:RDF xmlns="http://www.w3.org/2000/01/rdf-schema#" xmlns:rdfs="http://www.w3.org/2000/01/rdf-schema#" xmlns:ns="http://www.w3.org/2003/06/sw-vocab-status/ns#"
            ...
            <xsl:apply-templates select="$SEVA/*[name() = 'xs:complexType'][@name = 'SoftwareEvidenceArchiveType']" mode="rdf"/>
            <xsl:apply-templates select="$SEVA/*[name() = 'xs:complexType'][not(@name = 'SoftwareEvidenceArchiveType')]" mode="rdf"/>
            <xsl:apply-templates select="$SEVA/*[name() = 'xs:simpleType']" mode="rdf"/>
            <xsl:apply-templates select="$SEVA/*[name() = 'xs:element']" mode="rdf"/>
        </rdf:RDF>
    </xsl:template>
