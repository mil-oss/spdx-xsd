...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:owl="http://www.w3.org/2002/07/owl#"
    ...
    <xsl:variable name="xsdOut" select="'../xsd/spdx-xml-ref.xsd'"/>
    ...
    <xsl:variable name="FsfLibre">
        ...
        <xs:complexType name="IsFsfLibreType">
            <xs:annotation>
                ...
                <xs:appinfo>
                    <ComplexType name="IsFsfLibre" comment="Indicates if the license is is FSF Libre." rdf="http://spdx.org/rdf/terms#isFsfLibre" domain="License" range="Boolean" xmlns="urn:spdx-xml:1.0"
                    />
                </xs:appinfo>
            </xs:annotation>
            <xs:simpleContent>
            ...
            <xs:annotation>
                ...
                <xs:appinfo>
                    <ComplexType name="IsDeprecatedLicenseIDType" comment="Indicates if the license is is Deprecated." rdf="http://spdx.org/rdf/terms#isDeprecatedLicenseId" domain="License"
                        range="Boolean" xmlns="urn:spdx-xml:1.0"/>
                </xs:appinfo>
            </xs:annotation>
            <xs:simpleContent>
                <xs:extension base="xs:boolean">
            ...
            <xs:annotation>
                ...
                <xs:appinfo>
                    <ComplexType name="License" xmlname="License"
                        ...
                        rdf="http://spdx.org/rdf/terms#License" subclassof="SimpleLicensingInfo" xmlns="urn:spdx-xml:1.0"/>
                </xs:appinfo>
            </xs:annotation>
            <xs:complexContent>
    ...
    <xsl:template name="main">
        <xsl:result-document href="{$xsdOut}">
            <xs:schema xmlns="urn:spdx-xml:1.0" xmlns:ns="http://www.w3.org/2003/06/sw-vocab-status/ns#" xmlns:xs="http://www.w3.org/2001/XMLSchema"
                ...
                attributeFormDefault="unqualified" elementFormDefault="qualified" targetNamespace="urn:spdx-xml:1.0" version="1"
    ...
    <xsl:template match="SPDX/Class">
        ...
        <xsl:if test="@xmlname != 'License'">
            <xs:complexType name="{concat(@xmlname,'Type')}">
                <xs:annotation>
                    ...
                    <xs:appinfo>
                        <xsl:element name="ComplexType" xmlns="urn:spdx-xml:1.0">
                            <xsl:apply-templates select="@*" mode="identity"/>
                        </xsl:element>
                    </xs:appinfo>
                </xs:annotation>
        ...
        <xs:element name="{concat(@xmlname,'AugmentationPoint')}" abstract="true">
            <xs:annotation>
                ...
                <xs:appinfo>
                    <Element name="{concat(@xmlname,' Augmentation Point')}" xmlns="urn:spdx-xml:1.0"/>
                </xs:appinfo>
            </xs:annotation>
        </xs:element>
        <xs:element name="{@xmlname}" type="{concat(@xmlname,'Type')}" nillable="true">
            <xs:annotation>
                ...
                <xs:appinfo>
                    <Element xmlns="urn:spdx-xml:1.0">
                        <xsl:apply-templates select="@*" mode="identity"/>
                    </Element>
                </xs:appinfo>
            </xs:annotation>
    ...
    <xsl:template match="*/Class/Union" mode="enum">
        ...
        <xs:simpleType name="{concat($prop,'CodeSimpleType')}">
            <xs:annotation>
                ...
                <xs:appinfo>
                    <SimpleType name="{concat($prop,'CodeSimpleType')}" rdf="{@rdf}" xmlns="urn:spdx-xml:1.0"/>
                </xs:appinfo>
            </xs:annotation>
            <xs:restriction base="xs:string">
        ...
        <xs:complexType name="{concat($prop,'CodeType')}">
            <xs:annotation>
                ...
                <xs:appinfo>
                    <ComplexType name="{$prop,'CodeSimpleType'}" rdf="{@rdf}" xmlns="urn:spdx-xml:1.0"/>
                </xs:appinfo>
            </xs:annotation>
            <xs:simpleContent>
        ...
        <xs:element name="{concat($prop,'Code')}" type="{concat($prop,'CodeType')}" nillable="true">
            <xs:annotation>
                ...
                <xs:appinfo>
                    <Element name="{concat($prop,'Code')}" rdf="{@rdf}" xmlns="urn:spdx-xml:1.0"/>
                </xs:appinfo>
            </xs:annotation>
        </xs:element>
    </xsl:template>
    ...
    <xsl:template match="Restriction" mode="enum">
        ...
        <xs:enumeration value="{$v}">
            <xs:annotation>
                ...
                <xs:appinfo>
                    <Enum rdf="{@rdf}" xmlns="urn:spdx-xml:1.0"/>
                </xs:appinfo>
            </xs:annotation>
        </xs:enumeration>
    </xsl:template>
    ...
    <xsl:template match="SPDX/Datatype" mode="dt">
        ...
        <xs:element name="{@xmlname}" type="{concat(@xmlname,'Type')}" nillable="true">
            <xs:annotation>
                ...
                <xs:appinfo>
                    <xsl:element name="Element" xmlns="urn:spdx-xml:1.0">
                        <xsl:apply-templates select="@*" mode="identity"/>
                    </xsl:element>
                </xs:appinfo>
            </xs:annotation>
    ...
    <xsl:template match="*" mode="ctype">
        <xs:complexType name="{concat(@xmlname,'Type')}">
            <xs:annotation>
                ...
                <xs:appinfo>
                    <ComplexType xmlns="urn:spdx-xml:1.0">
                        <xsl:apply-templates select="@*" mode="identity"/>
                    </ComplexType>
                </xs:appinfo>
            </xs:annotation>
