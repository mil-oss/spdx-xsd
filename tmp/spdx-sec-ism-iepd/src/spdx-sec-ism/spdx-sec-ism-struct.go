...
//Annotation ... A data item for Annotation
type Annotation struct {
	Date	[]*Date		`xml:"Date,omitempty"  json:"Date[],omitempty"`
	AnnotationTypeCode	*AnnotationTypeCode		`xml:"AnnotationTypeCode,omitempty"  json:"AnnotationTypeCode,omitempty"`
	CommentText	[]*CommentText		`xml:"CommentText,omitempty"  json:"CommentText[],omitempty"`
	AnnotatorText	[]*AnnotatorText		`xml:"AnnotatorText,omitempty"  json:"AnnotatorText[],omitempty"`
	SecurityAttributesOptionGroup		//SecurityAttributesOptionGroup
	XMLName	xml.Name	`xml:"Annotation,omitempty"  json:"Annotation,omitempty"`
}
//AnnotationTypeCode ... A data item for AnnotationType properties
type AnnotationTypeCode struct {
	Value	string	`xml:",chardata"  json:"Value,omitempty"`
	SecurityAttributesOptionGroup		//SecurityAttributesOptionGroup
	XMLName	xml.Name	`xml:"AnnotationTypeCode,omitempty"  json:"AnnotationTypeCode,omitempty"`
}
//AnnotatorText ... A data type for This field identifies the person, organization or tool that has commented on a file, package, or entire document.
type AnnotatorText struct {
	Value	string	`xml:",chardata"  json:"Value,omitempty"`
	SecurityAttributesOptionGroup		//SecurityAttributesOptionGroup
	XMLName	xml.Name	`xml:"AnnotatorText,omitempty"  json:"AnnotatorText,omitempty"`
}
...
//CommentText ... A data type for CommentText
...
type CompanyInformation struct {
	NameText	*NameText		`xml:"NameText,omitempty"  json:"NameText,omitempty"`
	SecurityAttributesOptionGroup		//SecurityAttributesOptionGroup
...
//ComputerFileNameText ... A data item for a computer file name without extension
type ComputerFileNameText struct {
	Value	string	`xml:",chardata"  json:"Value,omitempty"`
	SecurityAttributesOptionGroup		//SecurityAttributesOptionGroup
	XMLName	xml.Name	`xml:"ComputerFileNameText,omitempty"  json:"ComputerFileNameText,omitempty"`
}
...
//Date ... A data type for A date-time stamp.
type Date struct {
	Value	string	`xml:",chardata"  json:"Value,omitempty"`
	SecurityAttributesOptionGroup		//SecurityAttributesOptionGroup
	XMLName	xml.Name	`xml:"Date,omitempty"  json:"Date,omitempty"`
}
//DeliveringOrganizationText ... A data item for the Organization of Delivery for the security
...
type FileInformation struct {
	ComputerFileNameText	*ComputerFileNameText		`xml:"ComputerFileNameText,omitempty"  json:"ComputerFileNameText,omitempty"`
...
//Name ... A data type for The full human readable name of the item. This should include version information when applicable.
type Name struct {
	Value	string	`xml:",chardata"  json:"Value,omitempty"`
	SecurityAttributesOptionGroup		//SecurityAttributesOptionGroup
	XMLName	xml.Name	`xml:"Name,omitempty"  json:"Name,omitempty"`
}
//NameText ... A data item for a name
type NameText struct {
	Value	string	`xml:",chardata"  json:"Value,omitempty"`
	SecurityAttributesOptionGroup		//SecurityAttributesOptionGroup
	XMLName	xml.Name	`xml:"NameText,omitempty"  json:"NameText,omitempty"`
}
...
//RelatedSpdxElementID ... A data item to identify the current SPDX document which may be referenced in relationships by other files, packages internally and documents externally.
type RelatedSpdxElementID struct {
	Value	string	`xml:",chardata"  json:"Value,omitempty"`
	SecurityAttributesOptionGroup		//SecurityAttributesOptionGroup
	XMLName	xml.Name	`xml:"RelatedSpdxElementID,omitempty"  json:"RelatedSpdxElementID,omitempty"`
}
//Relationship ... A data item for Relationship
type Relationship struct {
	RelationshipTypeCode	*RelationshipTypeCode		`xml:"RelationshipTypeCode,omitempty"  json:"RelationshipTypeCode,omitempty"`
	CommentText	[]*CommentText		`xml:"CommentText,omitempty"  json:"CommentText[],omitempty"`
	RelatedSpdxElementID	[]*RelatedSpdxElementID		`xml:"RelatedSpdxElementID,omitempty"  json:"RelatedSpdxElementID[],omitempty"`
	SecurityAttributesOptionGroup		//SecurityAttributesOptionGroup
	XMLName	xml.Name	`xml:"Relationship,omitempty"  json:"Relationship,omitempty"`
}
//RelationshipTypeCode ... A data item for RelationshipType properties
type RelationshipTypeCode struct {
	Value	string	`xml:",chardata"  json:"Value,omitempty"`
	SecurityAttributesOptionGroup		//SecurityAttributesOptionGroup
	XMLName	xml.Name	`xml:"RelationshipTypeCode,omitempty"  json:"RelationshipTypeCode,omitempty"`
}
...
//SpdxElement ... A data item for SpdxElement
type SpdxElement struct {
	SpdxID	*SpdxID		`xml:"SpdxID,omitempty"  json:"SpdxID,omitempty"`
...
//SpdxID ... A data item to identify the current SPDX document which may be referenced in relationships by other files, packages internally and documents externally.
type SpdxID struct {
	Value	string	`xml:",chardata"  json:"Value,omitempty"`
	SecurityAttributesOptionGroup		//SecurityAttributesOptionGroup
	XMLName	xml.Name	`xml:"SpdxID,omitempty"  json:"SpdxID,omitempty"`
}
