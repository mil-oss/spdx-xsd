...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
   ...
   -->
    ...
    <xsl:template name="main">
        <License xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:spdx-xml:1.0" xsi:schemaLocation="urn:spdx-xml:1.0  https://spdx-xml.specchain.org/spdx-license/file/iepxsd">
