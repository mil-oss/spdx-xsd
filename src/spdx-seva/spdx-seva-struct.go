...
type Dependencies struct {
	Dependency	[]string		`xml:"Dependency,omitempty"  json:"Dependency,omitempty"`
...
type DependencyInformation struct {
	Dependencies	string		`xml:"Dependencies,omitempty"  json:"Dependencies,omitempty"`
	Compiler	string		`xml:"Compiler,omitempty"  json:"Compiler,omitempty"`
...
type Ecosystem struct {
	...
	CommitLogs	string		`xml:"CommitLogs,omitempty"  json:"CommitLogs,omitempty"`
	XMLName	xml.Name		`xml:"Ecosystem,omitempty"  json:"Ecosystem,omitempty"`
}
//EcosystemInformation ... 
type EcosystemInformation struct {
	Ecosystem	string		`xml:"Ecosystem,omitempty"  json:"Ecosystem,omitempty"`
...
type ScoreDetails struct {
	CommonVulnerabilityScoringSystemV2	string		`xml:"CommonVulnerabilityScoringSystemV2,omitempty"  json:"CommonVulnerabilityScoringSystemV2,omitempty"`
	CommonVulnerabilityScoringSystemV3	[]string		`xml:"CommonVulnerabilityScoringSystemV3,omitempty"  json:"CommonVulnerabilityScoringSystemV3,omitempty"`
...
type SoftwareEvidenceArchive struct {
	SoftwareInformation	string		`xml:"SoftwareInformation,omitempty"  json:"SoftwareInformation,omitempty"`
	FileInformation	string		`xml:"FileInformation,omitempty"  json:"FileInformation,omitempty"`
	AuthoritativeSourceInformation	string		`xml:"AuthoritativeSourceInformation,omitempty"  json:"AuthoritativeSourceInformation,omitempty"`
	EcosystemInformation	string		`xml:"EcosystemInformation,omitempty"  json:"EcosystemInformation,omitempty"`
	DependencyInformation	string		`xml:"DependencyInformation,omitempty"  json:"DependencyInformation,omitempty"`
	LicenseInformation	string		`xml:"LicenseInformation,omitempty"  json:"LicenseInformation,omitempty"`
	VulnerabilityInformation	string		`xml:"VulnerabilityInformation,omitempty"  json:"VulnerabilityInformation,omitempty"`
	GovernanceRiskCompliance	string		`xml:"GovernanceRiskCompliance,omitempty"  json:"GovernanceRiskCompliance,omitempty"`
	DeliveryInformation	string		`xml:"DeliveryInformation,omitempty"  json:"DeliveryInformation,omitempty"`
...
type SoftwareInformation struct {
	...
	VersionInformation	string		`xml:"VersionInformation,omitempty"  json:"VersionInformation,omitempty"`
...
type VersionInformation struct {
	...
	SemanticVersionInformation	string		`xml:"SemanticVersionInformation,omitempty"  json:"SemanticVersionInformation,omitempty"`
	...
	PythonSemanticVersion	string		`xml:"PythonSemanticVersion,omitempty"  json:"PythonSemanticVersion,omitempty"`
...
type VirusInformation struct {
	...
	EngineDetails	string		`xml:"EngineDetails,omitempty"  json:"EngineDetails,omitempty"`
	XMLName	xml.Name		`xml:"VirusInformation,omitempty"  json:"VirusInformation,omitempty"`
}
//Vulnerabilities ... 
type Vulnerabilities struct {
	Vulnerability	[]string		`xml:"Vulnerability,omitempty"  json:"Vulnerability,omitempty"`
...
type Vulnerability struct {
	...
	ScoreDetails	string		`xml:"ScoreDetails,omitempty"  json:"ScoreDetails,omitempty"`
	...
	VulnerabilityReference	[]string		`xml:"VulnerabilityReference,omitempty"  json:"VulnerabilityReference,omitempty"`
...
type VulnerabilityInformation struct {
	Vulnerabilities	string		`xml:"Vulnerabilities,omitempty"  json:"Vulnerabilities,omitempty"`
	VirusInformation	string		`xml:"VirusInformation,omitempty"  json:"VirusInformation,omitempty"`
