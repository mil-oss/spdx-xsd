...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:exsl="http://exslt.org/common" xmlns:str="http://exslt.org/strings"
    ...
    <xsl:variable name="nspc" select="'urn:spdx-seva::1.0'"/>

    <xsl:template name="makeXSD">
        <xsl:param name="xsdnodes"/>       
        <xs:schema xmlns="urn:spdx-seva::1.0" attributeFormDefault="unqualified" elementFormDefault="qualified" targetNamespace="urn:spdx-seva::1.0" version="1" xmlns:xs="http://www.w3.org/2001/XMLSchema">
